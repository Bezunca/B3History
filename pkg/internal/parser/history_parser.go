...
func parseContentLine(rawLine string, year int) (*models.AssetInfo, error) {
	...
	return &models.AssetInfo{
		...
		PriceOpen:              models.FixedPoint(priceOpen),
		PriceMax:               models.FixedPoint(priceMax),
		PriceMin:               models.FixedPoint(priceMin),
		PriceMean:              models.FixedPoint(priceMean),
		PriceClose:             models.FixedPoint(priceClose),
		PriceBid:               models.FixedPoint(priceBid),
		PriceAsk:               models.FixedPoint(priceAsk),
		TotalTrades:            int(totalTrades),
		TotalQuantity:          int(totalQuantity),
		TotalVolume:            models.FixedPoint(totalVolume),
		PreExe:                 models.FixedPoint(preExe),
		IndOpc:                 int(indOpc),
